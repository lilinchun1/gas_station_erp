                    ...
                    <div class="role-inquire channel-index-btns">
                        <form id="formid" name="channelSelect" method="get" action="">
                            <p>
                                ...
                                <input type="button" id="do_search_bt" class="role-control-btn" value="导出" />
                            </p>
                        </form>
                    </div>
                        ...
                        <div class="role-table">
                            <ul class="statistics-list">
                                <li>
                                    ...
                                    <span class='span-1'><b>素材类型</b></span>
                                    <span class='span-1'><b>实际播放次数</b></span>
                                    <span class='span-1'><b>实际播放时长</b></span>
                                    <span class='span-1'><b>单词指定播放时长</b></span>
                                </li>
                                <li class="list_sel">
