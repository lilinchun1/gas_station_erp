            ...
            <div class="org-right-con">
                    ...
                    <div class="role-inquire channel-index-btns">
                        <form name="channelSelect" method="get" action="">
                            ...
                            <p>
                                ...
                                <label for="day2">按日统计</label>
                                <select name="" id="" class="channel-select">
                ...
                <div class="role-table station-chart">
                    <div class="tubiao4">
                        ...
                        <div class="role-table3">
                            <ul class="statistics-list">
                                <li>
                                    <span class='span-1'><b>应用名称</b></span>
                                    <span class='span-1'><b>应用类型</b></span>
                                    <span class='span-1'><b>安装数量</b></span>
                                    <span class='span-1'><b>占比</b></span>
                                    <span class='span-1'><b>所在位置</b></span>
                                </li>
                                <li>
                    ...
                    <div class="tab-wrap">
                        ...
                        <div class="hd">
                            <div class="bingtu-tt">
                                渠道安装量分析<input type="submit" class="role-control-btn fr" value="导出" />
                            </div>
                        </div>
                        <div class="bd">
