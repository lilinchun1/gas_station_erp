...
<script type="text/javascript">
	...
	.jcSlider { width:940px; height:260px; background:url(__PUBLIC__/image/pic/sliderbg.png) no-repeat; padding:0px;}
	.imgHide { width:940px; height:260px; overflow:hidden; }
	.imgList { height:260px; width:900px;  top:0; left:0; z-index:1;}
	.imgList li {  left:0; top:0; height:260px; width:940px; list-style:none; display:none; overflow:hidden; }
