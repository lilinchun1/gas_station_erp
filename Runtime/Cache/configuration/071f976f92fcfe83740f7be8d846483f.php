				...
				<div class="role-control" id="j-fixed-top">
					<div class="role-inquire">
						<form name="roleSelect" method="get" action="<?php echo U('configuration/Role/show_role');?>">
							...
							<input type="text" name="role_name_txt" id="role_name_txt" value="<?php echo ($_GET['role_name_txt']); ?>" autocomplete="off" class="input-org-info" onfocus="blurry('role_name','<?php echo U('channel/Channel/getAllLike');?>',this)"/>
