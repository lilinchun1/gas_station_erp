				...
				<div class="role-control" id="j-fixed-top">
					<div class="role-inquire">
						<form name="userSelect" method="get" action="<?php echo U('configuration/User/show_user');?>">
							...
							onfocus="blurry('realname','<?php echo U('channel/Channel/getAllLike');?>',this)"/>
							...
							onfocus="blurry('agent_name','<?php echo U('channel/Channel/getAllLike');?>',this)"/>
				...
				<div class="role-table over-h-y">
					<ul class="role-table-list">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list_sel">
								<span class="span-1">
									<input type="radio" name="radio_list" value="<?php echo ($vo['uid']); ?>"  class="role-table-radio"/>
								</span>
		...
		<div class="alert-user-add-con">
			<form action="">
				...
				<p>
					...
					<input type="radio" name="change-sex"  checked="checked" class="change-sex" id="man" value="1"/><label for="man" class="sex">男</label>
