                ...
                <div class="org-right-info" id="j_org">
                    <h3>组织机构信息</h3>
                        <div class="info-left cf">
                            <label for="change_agent_name_txt">组织机构名称</label><input type="text" name="" id="change_agent_name_txt" readonly class="input-org-info long-input"/>
                            <label for="linkman">法人代表</label><input readonly type="text" name="" id="change_legal_txt" class="input-org-info"/>
                            <label for="address">办公地址</label><input readonly type="text" name="" id="change_companyAddr_txt" class="input-org-info"/>
                            <label for="contract-number">合同编号</label><input readonly type="text" name="" id="change_contract_number_txt" class="input-org-info"/>
                            <input type="hidden" id="agent_id_hid" value=""/>
                            <input type="hidden" id="agent_pid_hid" value=""/>
                        </div>
                    <div class="info-right cf">

                            <label for="org-s">上级组织机构</label><input readonly type="text" name="" id="father_agent_name" class="input-org-info long-input"/>
                            <label for="phone">法人代表电话</label><input readonly type="text" name="" id="change_legal_tel_txt" class="input-org-info"/>
                        <label class="wenben">公司电话</label><input readonly type="text" name="tel_txt" id="change_tel_txt" class="input-org-info" />
                            <label for="yw-are">业务区域</label><input readonly type="text" name="" id="area_name" class="input-org-info"/>
                            ...
                            <em>
								...
								<input readonly type="text" name="" id="sq-date" class="input-org-info min-w"/>
                                <input readonly type="text" name="" id="date" class="input-org-info min-w"/>
...
<div class="alert-org-add" id="j_add_win" style=" display:none;">
    <div class="org-right-info" id="add">
        ...
        <form action="">
            <div class="info-left cf">
                <label for="org">组织机构名称</label><input type="text" name="" id="j_add_org" class="input-org-info long-input"/><i class="red-color pdl10">*</i>
                <label for="linkman">法人代表</label><input type="text" name="" id="j_add_linkman" class="input-org-info"/>
            ...
            <div class="info-right cf">
                <label for="org-s">上级组织机构</label><input type="text" name="" id="j_add_org-s" class="input-org-info long-input" readonly />
                <label for="phone">法人代表电话</label><input type="text" name="" id="j_add_phone" class="input-org-info"/>
                <label class="wenben">公司电话</label><input type="text" name="add_tel_txt" id="add_tel_txt" class="input-org-info" />
                <label for="yw-are">业务区域</label><input type="text" name="" id="restxts" class="input-org-info" readonly/><i class="red-color pdl10">*</i>
                ...
                <em>
                    <label for="sq-date">授权日期</label>
					<input type="text" name="" id="j_add_sq-date" class="input-org-info min-w" onClick="WdatePicker()" readonly/>
                    <input type="text" name="" id="j_add_date" class="input-org-info min-w" onClick="WdatePicker()" readonly/>
...
$.ajax({
    ...
    success: function(data){
        $.each(data,function(key,val){
            var kid=val['agent_id'];
            var parent=val['father_agentid'];
            var value=val['agent_name'];
        ...
        $('#j_add_save').click(function(){
           ...
           // var add_agent_level_sel=$('#add_agent_level_sel').val();//代理商级别
            ...
            else
            {
				...
				if(add_begin_time_sel==""||add_end_time_sel==""){
					alert("请选择授权时间");
					return false;
				}
...
//=====================================================单击修改按钮事件======================================================
    $('#j_mod_button').click(function(){
		...
		$("#j-choose").click(function(){
			...
			var url="<?php echo U('configuration/Org/show_org_area_tree');?>";
			var can_url="<?php echo U('configuration/Org/canBeDeleteArea');?>";
