                ...
                <div class="org-right-info" id="j_org">
                    <h3>组织机构信息</h3>
                        <div class="info-left cf">
                            <label for="change_agent_name_txt">组织机构名称</label><input type="text" name="" id="change_agent_name_txt" readonly="true" class="input-org-info long-input"/>
                            <label for="linkman">法人代表</label><input readonly="true" type="text" name="" id="change_legal_txt" class="input-org-info"/>
                    ...
                    <div class="info-right cf">
                            ...
                            <label for="org-s">上级组织机构</label><input readonly="true" type="text" name="" id="father_agent_name" class="input-org-info long-input"/>
                            <label for="phone">法人代表电话</label><input readonly="true" type="text" name="" id="change_legal_tel_txt" class="input-org-info"/>
                        <label class="wenben">公司电话</label><input readonly="true" type="text" name="tel_txt" id="change_tel_txt" class="input-org-info" />
                            <label for="yw-are">业务区域</label><input readonly="true" type="text" name="" id="area_name" class="input-org-info"/>
...
<div class="alert-org-add" id="j_add_win" style=" display:none;">
    <div class="org-right-info" id="add">
        ...
        <form action="">
            ...
            <div class="info-right cf">
                <label for="org-s">上级组织机构</label><input type="text" name="" id="j_add_org-s" class="input-org-info long-input" readonly="readonly" />
                ...
                <label for="yw-are">业务区域</label><input type="text" name="" id="restxts" class="input-org-info" readonly="readonly"/><i class="red-color pdl10">*</i>
