    ...
    <div class="bd over-h-y">
        <ul class="role-table-list">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<span class="span-1">
						<input type="radio" name="<?php echo ($vo['deviceRadioID']); ?>" id="<?php echo ($vo['deviceRadioID']); ?>" value="<?php echo ($vo['device_id']); ?>"
							 onclick="selectDeviceRadio('<?php echo ($vo['device_id']); ?>');" class="role-table-radio"/></span>
...
<script>
	var device_val='';
	function selectDeviceRadio(device_id){
